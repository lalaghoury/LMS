...
const AssinmentSubmissionDetailsPage = ({
  ...
  const { singleSubmission } = useAppSelector((state) => state.submissions);
        ...
        <div className="w-full flex gap-2 items-center justify-between">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56">
              <DropdownMenuLabel>Add Grade</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuRadioGroup
                value={singleSubmission?.grade}
                onValueChange={(grade) =>
                  dispatch(
                    submissionThunks.updateGrade({
                      batchId,
                      assignmentId,
                      submissionId,
                      grade,
